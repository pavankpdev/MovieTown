      ...
      <div>
        <div className="px-4 py-3 flex justify-between items-center">
          ...
          <div className="sm:hidden md:hidden lg:block xl:block">
            ...
            <button className="ml-4 mt-3 uppercase tracking-widest font-semibold px-3 py-1 text-sm text-white border-2 border-logoColor rounded bg-logoColor hover:bg-white hover:text-logoColor focus:bg-white focus:text-logoColor focus:outline-none">
              sign up
            </button>
          </div>
        </div>
        ...
        <div
          className={this.state.isClicked ? "block" : "hidden" + " pt-2 pb-4"} // validating toggle
        >
